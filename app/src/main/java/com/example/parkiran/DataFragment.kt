...
import com.example.parkiran.model.ModelPendapatan
...
class DataFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_data2, container, false)
